<?php
   ...
   $sql = "INSERT INTO productos (cod_pro, nom_pro, catg_pro, precio_prod, fecha_alta_pro, id_usu_alta, fecha_edit_pro, id_usu_edit) values ('$cod_pro', '$nom_pro', '$catg_pro', '$precio_prod', '$fecha_alta_pro', '$id_usu_alta', '$fecha_edit_pro', '$id_usu_edit')";
