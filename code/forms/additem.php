...
<html lang="es">
    <head>
    	...
    	<script type="text/javascript">
    		...
    		{  
        		...
        		{
            		$('#result-cod_pro').html('<img src="https://cdn.pixabay.com/animation/2023/11/30/10/11/10-11-02-622_512.gif" style="width: 60px; height: auto;"/>').fadeOut(1000);
    ...
    <body>
		...
		<center>
	    	<img src='../../img/logo.png' width="50" height="50" class="responsive">
		</center>
		<br />
<?php
...
?>
		...
		<div class="container">
			<h1><b><i class="fa-solid fa-boxes-stacked"></i> REGISTRO DE PRODUCTOS</b></h1>
			...
			<form action='additem1.php' enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
	                <div class="row">
	                	<div class="col-12 col-sm-3">
	                        <label for="catg_pro">* CATEGORÍA:</label>
	                    ...
	                    <div class="col-12 col-sm-2">
	                        <label for="fecha_pro">FECHA PROD.</label>
	                        <input type='date' name='fecha_pro' class='form-control' required />
	                    </div>
	                </div>
            	</div>
